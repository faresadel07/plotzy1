...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[52rem] md:h-[68rem] flex items-center justify-center relative p-2 md:p-4"
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[36rem] md:h-[46rem] w-full shadow-2xl relative"
    >
      {/* Cover boards */}
      <div
        style={{
