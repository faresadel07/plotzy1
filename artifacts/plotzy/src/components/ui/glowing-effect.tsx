...
const GlowingEffect = memo(
  ({
    ...
    // Plotzy gold gradient — warm amber/gold tones matching the brand
    const goldGradient = `
      radial-gradient(circle, #FFD966 10%, #FFD96600 20%),
      ...
      repeating-conic-gradient(
        ...
        #FFD966 calc(100% / var(--repeating-conic-gradient-times))
      )`;
