...
const STEPS: StepDef[] = [
  {
    key: "type",
    q: { en: "What are you writing today?", ar: "ماذا تكتب اليوم؟" },
    hint: { en: "(pick the shape, not the words)", ar: "(اختر الشكل، لا الكلمات)" },
    options: [
      { label: { en: "A how-to or guide", ar: "شرح أو دليل عملي" }, value: "howto" },
  ...
  {
    key: "goal",
    q: { en: "How deep are you going?", ar: "ما مدى عمق مقالك؟" },
    hint: { en: "(sets a gentle word goal, change it anytime)", ar: "(يحدد هدفاً للكلمات، ويمكنك تغييره في أي وقت)" },
    options: [
      { label: { en: "Quick take · 300 words", ar: "لمحة سريعة · 300 كلمة" }, value: 300 },
      { label: { en: "Standard · 800 words", ar: "متوسط · 800 كلمة" }, value: 800 },
      { label: { en: "Deep dive · 1500 words", ar: "تعمّق · 1500 كلمة" }, value: 1500 },
    ],
  },
  {
    key: "tone",
    q: { en: "What should it feel like?", ar: "ما النبرة التي تريدها؟" },
    hint: { en: "(your voice, your call)", ar: "(صوتك أنت، والقرار لك)" },
    options: [
      { label: { en: "Warm and personal", ar: "دافئة وشخصية" }, value: "warm" },
      { label: { en: "Clear and practical", ar: "واضحة وعملية" }, value: "practical" },
      { label: { en: "Bold and honest", ar: "جريئة وصريحة" }, value: "bold" },
      { label: { en: "Literary and slow", ar: "أدبية ومتأنية" }, value: "literary" },
    ],
  },
  {
    key: "audience",
    q: { en: "Who are you writing for?", ar: "لمن تكتب؟" },
    hint: { en: "(keeps one reader in mind)", ar: "(ضع قارئاً واحداً في بالك)" },
    options: [
      { label: { en: "Fellow writers", ar: "كتّاب مثلك" }, value: "writers" },
      { label: { en: "Beginners", ar: "مبتدئون" }, value: "beginners" },
      { label: { en: "General readers", ar: "قرّاء عامّون" }, value: "general" },
      { label: { en: "Just for me", ar: "لنفسي فقط" }, value: "self" },
    ],
  },
  {
    key: "outline",
    q: { en: "Want a head start?", ar: "هل تريد بداية جاهزة؟" },
    hint: { en: "(a light outline you can fill or delete)", ar: "(هيكل خفيف يمكنك ملؤه أو حذفه)" },
    options: [
      { label: { en: "Yes, give me an outline", ar: "نعم، أعطني هيكلاً" }, value: "yes" },
      { label: { en: "No, blank page please", ar: "لا، صفحة فارغة" }, value: "no" },
    ],
  },
];
