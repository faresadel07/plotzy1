...
export function AuthModal({ open, onClose }: AuthModalProps) {
  ...
  const [providers, setProviders] = useState({ google: false, apple: false, linkedin: false, microsoft: false, email: true });
      ...
      >
        ...
        <div style={{ padding: "24px 22px 26px", display: "flex", flexDirection: "column", gap: 0 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 18 }}>
            ...
            {providers.microsoft && (
              <SocialBtn
                src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 23 23'%3E%3Cpath fill='%23f25022' d='M1 1h10v10H1z'/%3E%3Cpath fill='%237fba00' d='M12 1h10v10H12z'/%3E%3Cpath fill='%2300a4ef' d='M1 12h10v10H1z'/%3E%3Cpath fill='%23ffb900' d='M12 12h10v10H12z'/%3E%3C/svg%3E"
                alt="Microsoft" label={ar ? "المتابعة عبر Microsoft" : "Continue with Microsoft"}
                href="/auth/microsoft" enabled={providers.microsoft}
              />
            )}
            {providers.linkedin && (
              <SocialBtn
                src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%230A66C2'%3E%3Cpath d='M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.063 2.063 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z'/%3E%3C/svg%3E"
                alt="LinkedIn" label={ar ? "المتابعة عبر LinkedIn" : "Continue with LinkedIn"}
                href="/auth/linkedin" enabled={providers.linkedin}
              />
            )}
          </div>
