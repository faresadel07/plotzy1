...
**Is the protagonist's want clear by chapter 2 or page 30?** *Why:* readers form their investment from the want; without it on page one they don't yet care what happens. (Callback to [M3 L1](/learn/lesson/characters-protagonist-wound).)

**Is there a clear inciting incident in Act 1?** *Why:* the disturbance to the normal is what makes Act 2 necessary; without it, the story keeps introducing.

**Is there a lock-in by the end of Act 1?** *Why:* without a choice the protagonist cannot un-make, Act 2 has nothing to start from. The reader can feel an unfinished Act 1 even when they can't articulate it.

**Is there a midpoint reversal at roughly the middle?** *Why:* a sagging middle is almost always a missing midpoint. The midpoint is what gives the second half a different shape from the first.

**Is there a dark moment late in Act 2?** *Why:* the climax in Act 3 has nothing to climb out of without a floor in Act 2. Stories without a dark moment feel like the writer pulled a punch.

**Does the protagonist *change* by the end?** *Why:* the change ingredient is non-negotiable. A story whose situation changed but whose character didn't is a complaint, not a story. (Callback to [M1 L4](/learn/lesson/foundation-three-ingredients).)

**Does every act break feel earned?** *Why:* unearned act breaks make the reader feel manipulated. The reader should feel *the story arrived here*, not *the writer needed an act break here*.

## Pass 2: scene-level

**Does this scene have the three ingredients?** *Why:* a scene is a small story; without want, obstacle, and change it doesn't function as a unit of narrative. The reader senses the scene as filler even when they can't say why.

**Does the scene start late and end early?** *Why:* most beginner scenes contain a paragraph of throat-clearing at each end that the reader skims. Cutting the first and last paragraph of a draft scene usually improves it.

**Are the right characters present?** *Why:* a scene with two characters who could be one is a scene that hasn't been edited yet. (Callback to [M3 L4](/learn/lesson/characters-supporting-cast).)
...
**Is description load-bearing?** *Why:* description that doesn't tell us about the character, set up something later, or carry needed atmosphere is cut. (Callback to [M4 L4](/learn/lesson/world-description-pace).)

**Does each shown scene engage at least two senses?** *Why:* the visual default flattens shown scenes. A scene with only sight engaged feels flat to the reader even when they can't say why. (Callback to [M4 L2](/learn/lesson/world-sensory-writing).)

**Have you read this aloud?** *Why:* the ear catches what the eye doesn't. The most reliable single line-level diagnostic.
